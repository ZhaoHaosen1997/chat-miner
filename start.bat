...
echo   Backend:  http://localhost:28856
echo   Frontend: http://localhost:5173
echo   API Docs: http://localhost:28856/docs
echo ============================================
echo.
...
start "Chat-Miner-Backend" /d "%ROOT%" cmd /c "python -m uvicorn main:app --host 0.0.0.0 --port 28856"

echo Waiting for backend to start...
:wait_backend
timeout /t 2 /nobreak >nul
curl -s -o nul -w "%%{http_code}" http://localhost:28856/api/health 2>nul | findstr "200" >nul
