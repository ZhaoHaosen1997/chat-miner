...
PORTRAIT_PROMPTS = {
    "persona": {
        "system": "你是一个人物分析工具。每行一个标签。不要输出任何其他内容，不要解释。标签要具体、有区分度，避免用\"幽默\"\"话痨\"这种放谁身上都行的词。只有真正话多的人才用\"话痨\"。",
        "user": "{chat}\n\n以上是 {name} 的发言。分析ta的特征，输出三行：\n第一行：性格标签（逗号分隔，2-3个。选最能区分ta的，如：较真/随和/社恐/自来熟/刀子嘴/老好人/玻璃心/佛系/急性子/细节控/强迫症/摆烂王/卷王/乐子人/吃货/愤青/文艺/实用主义）\n第二行：说话风格（一个词，如：豪爽/温柔/毒舌/理性/活泼/老成/沙雕/阴阳怪气/一本正经/骚话连篇/惜字如金/直球/拐弯抹角/杠精/捧场王/冷场王）\n第三行：群内角色（从以下选一个：气氛组/和事佬/话题制造机/话题终结者/吃瓜群众/潜水大佬/毒舌评论员/科普达人/摸鱼冠军/卷王/凡尔赛大师/画饼专家/真香选手/社死担当/破防boy/摆烂王者）\n\n你的输出：",
    },
    "interests": {
    ...
    "oneline_portrait": {
        "system": "你是一个人物素描工具。两行输出：人设+emoji。要精准抓特点，不要套模板。不要输出任何其他内容。",
        "user": "{chat}\n\n以上是 {name} 的发言。用一句话+emoji形容ta：\n第一行：15字一句话人设。要具体到ta的话题或行为，不要泛泛的\"热心老大哥\"型描述。好的例子：\n  \"每天分享早餐的奶茶品鉴师\"\n  \"一开口就歪楼的飙车党\"\n  \"深夜emo完早上装没事的戏精\"\n  \"只发表情包不说话的存在感选手\"\n第二行：2个emoji形容ta\n\n你的输出：",
    },
}
